            ...
            <div>
                ...
                <Announcement />
                    <div className="believe text-center py-20">
                        <h1 className='text-3xl font-semibold pb-10'>WHAT WE BELIEVE</h1>
