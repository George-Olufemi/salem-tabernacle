        ...
        <nav className="md:flex md:justify-end h-42 md:h-16  text-yellow-700 z-50 md:bg-transparent hidden md:block">
            ...
            <div className="">
                <ul className={(open ? 'left-0':'-left-full') + ' md:flex pt-5 absolute md:static md:bg-transparent md:z-auto w-full h-full md:w-auto transition-all duration-300'}>
                    ...
                    <Link to="/livestream"><li className='mr-10 md:pt-0 text-center text-lg tracking-wider transition-all hover:scale-105'>Live Stream</li></Link>
                    <Link to="/locate-us"><li className='mr-16 pt-3 md:pt-0 text-center text-lg tracking-wider transition-all hover:scale-105 border-yellow-700 md:hover:border-yellow-700 md:border-b-4'>Locate Us</li></Link>
                </ul>
            </div>
        </nav>
    </React.Fragment>
